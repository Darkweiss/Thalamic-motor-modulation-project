...
%triggers
%% get file names
path = 'Y:\Matt\chronic mouse 8 open ephys\Day9\'; %this is the path where the folders produced by openephys are
cd(path);
Files = dir(path);
%get file names
...
kilosort_files = file_names(3:8); %select the files you want for kilosort
