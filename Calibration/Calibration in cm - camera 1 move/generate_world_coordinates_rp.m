...
x0 = [0 4.8  9.6  15.2  20 24.8  0 4.8  9.6  15.2  20 24.8 0 4.8  9.6  15.2  20 24.8 0 4.8  9.6  15.2  20 24.8]; x0 = x0-mean(x0); Nx0 = length(x0); 
y0 = [0 0  0   0   0  0   9.6 9.6 9.6  9.6  9.6 9.6 15.2 15.2 15.2  15.2  15.2 15.2 24.8 24.8 24.8  24.8  24.8 24.8]; y0 = y0-mean(y0); Ny0 = length(y0);
